...
const projects = [
  ...
  {
    title: "Movie Plex",
    desc: "A personal media streaming platform with smart recommendations and family sharing.",
    img: "/images/movieplex-cover.webp",
    tags: ["Docker", "Jellyfin", "Python", "Automation"],
    liveUrl: "#",
    codeUrl: "#",
  },
  {
  ...
  {
    title: "Mojito Mix",
    desc: "A cocktail recipe discovery app with AI-powered flavor pairing suggestions.",
    img: "/images/mojito-cover.webp",
    tags: ["React", "AI", "Food & Drink", "API"],
    liveUrl: "#",
    codeUrl: "#",
  },
  {
